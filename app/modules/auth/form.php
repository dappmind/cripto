<?php
if (!isset($settings) || ($logged_in['flag'] && $_SESSION['two_factor'] == '')) {
    header('location: /');
    exit;
}
...
<nav class="top">
    <div class="container">
        <div class="top__right">
            <?php if ($module != 'two_factor') { ?>
                <div class="auth top__block"><a class="auth__signup"
                                                href="/<?= $href ?>/"><?= $lng['auth_' . $href . ''] ?></a>
                </div><?php } ?>
            <ul class="menu top__block">
                <li class="menu__item"><a class="menu__link" href="<?= $product['url_main'] ?>/getlcd" target="_blank">#GETLCD</a>
                </li>
                <li class="menu__item"><a class="menu__link" href="<?= $product['url_main'] ?>" target="_blank">Main
                        website</a></li>
            </ul>
            <div class="langs top__block"><a class="langs__link langs__link--current"
                                             href="/<?= $lng['language_code'] ?>/"><?= $lng['language_code'] ?></a>
                <div class="langs__hidden"><a class="langs__link<?php if ($lng['language_code'] == 'en') {
                        echo ' langs__link--active';
                    } ?>" href="/en/">en</a><a class="langs__link<?php if ($lng['language_code'] == 'ru') {
                        echo ' langs__link--active';
                    } ?>" href="/ru/">ru</a><a class="langs__link<?php if ($lng['language_code'] == 'ja') {
                        echo ' langs__link--active';
                    } ?>" href="/ja/">ja</a><a class="langs__link<?php if ($lng['language_code'] == 'ko') {
                        echo ' langs__link--active';
                    } ?>" href="/ko/">ko</a><a class="langs__link<?php if ($lng['language_code'] == 'cn') {
                        echo ' langs__link--active';
                    } ?>" href="/cn/">cn</a></div>
            </div>
            <div class="top__copy"><?= $product['footer_copyright'] ?> <img
                        src="/assets/products/<?= $product['id'] ?>/logo_small@2x.png" width="69" alt=""/></div>
        </div>
        <a class="logo" href="<?= $product['url_main'] ?>" target="_blank"><img
                    src="/assets/products/<?= $product['id'] ?>/logo.png"
                    srcset="/assets/products/<?= $product['id'] ?>/logo@2x.png 2x" alt=""/></a>
    </div>
</nav>
<?php
if ($module == 'signin') {
            ...
            <form class="form form--portal" id="signin-form" method="post" action="" novalidate="novalidate">
                ...
                <div class="form__content">
                    ...
                    <div class="form__group">
                        ...
                        <input class="form__input" name="password" placeholder="<?= $lng['field_password'] ?>"
                               type="password"/>
                        <span id="signin-password-error" class="form__error" style="display: none;"></span>
                    </div>
                    <div class="captcha" style="text-align: center;">
                        <ul class="scl-nav">
                            <?php if ($product['twitter_consumer_key'] != '' && $product['twitter_consumer_secret'] != '') {
                                echo '  <li><a href="/auth/twitter/" class="twi"><i class="fa fa-twitter"></i></a></li>';
                            } ?>
                            <?php if ($product['facebook_app_id'] != '' && $product['facebook_app_secret'] != '') {
                                echo '  <li><a href="/auth/facebook/" class="fc"><i class="fa fa-facebook"></i></a></li>';
                            } ?>
                            <?php if ($product['google_oauth'] == '1') {
                                echo '  <li><a href="/auth/google/" class="g-p"><i class="fa fa-google-plus"></i></a></li>';
                            } ?>
                        </ul>
                    </div>
                    ...
                    <div class="form__links"><a class="form__link form__link--grey"
                                                href="/signup/"><?= $lng['auth_signup_link'] ?></a> <?= $lng['auth_or'] ?>
                        <a class="form__link form__link--grey" href="/reset/"><?= $lng['auth_reset_link'] ?></a>
                    </div>
                </div>
            </form>
        </div>
...
//    e.stopImmediatePropagation();
        ...
        $.ajax({
          ...
          success: function (result) {
            ...
            if (result.status == 'success' || result.status == 'signed_in') {
...
<!--    <script src="https://www.google.com/recaptcha/api.js" async defer></script>-->
    <div class="wrapper">
        <div class="container">
            <form class="form form--portal" id="signup-form" method="post" action="" novalidate="novalidate" onsubmit="return false;">
                ...
                <div class="form__content">
                    ...
                    <div class="message message--success message--form" id="signup-success"
					...
					<div class="form__group">
						<label class="form__label"><?= $lng['label_password'] ?></label>
						<input class="form__input" name="password" id="signup-password"
                               placeholder="<?= $lng['field_password'] ?>" type="password"/>
						<span id="signup-password-error" class="form__error" style="display: none;"></span>
						<span class="password-strength" id="password-strength"><?= $lng['password_strength'] ?>
                            : <?= $lng['password_weak'] ?></span>
					</div>
					<div class="form__group">
						<label class="form__label"><?= $lng['label_password_confirmation'] ?></label>
						<input class="form__input" name="password_confirmation"
                               placeholder="<?= $lng['field_password_confirmation'] ?>" type="password"/>
						<span id="signup-password_confirmation-error" class="form__error" style="display: none;"></span>
					</div>
					<div class="form__group">
						<!--<label class="form__label"><?= $lng['field_ethereum_address'] ?><?php if ($product['ethereum_field_required'] == '0') {
                            echo ' ' . $lng['recommended'];
                        } ?></label>
                        ...
                        <?php if ($product['captcha_enabled'] == '1') { ?>
                            <div class="form__group">
                            <label class="form__label"><?= $lng['field_captcha'] ?></label>
                            <div class="captcha" style="text-align: center;margin: 0 auto 20px;"><img src="/captcha/"
                                                                                                      id="captcha-image"
                                                                                                      style="cursor: pointer;"></div>
                            <input class="form__input" name="captcha" id="captcha"
                                   placeholder="<?= $lng['field_captcha'] ?>" type="text"/>
                            <span id="signup-captcha-error" class="form__error" style="display: none;"></span>
                            </div>
                        <?php }
                        if ($product['user_agreement'] != '') {
                            ?><label class="form__checkbox form__checkbox--agree" id="signup-agree"><input
                                    type="checkbox" name="agree" value="1"/><span></span><?= $lng['checkbox_agree'] ?><a
                                    class="form__link" href="<?= $product['user_agreement'] ?>"
                                    target="_blank"><?= $lng['user_agreement'] ?></a></label><?php } ?>
                        <div class="text--center">
						<div class="m-spinner m-spinner--auth m-spinner--lg" id="loading" style="display: none;"></div>
						<button type="submit" id="signup-button" class="btn" onclick="onSubmit()">
                            <?= $lng['auth_button_signup'] ?>
                        </button>
					</div>
					<div class="form__links"><?= $lng['auth_or'] ?>
                        <a class="form__link form__link--grey" href="/signin/">
                            <?= $lng['auth_signin_link'] ?>
                        </a>
					</div>
					</span>
                </div>
        ...
        <div class="container">
            <form class="form form--portal" id="two_factor-form" method="post" action="" novalidate="novalidate">
                ...
                <div class="form__content">
                    ...
                    <div class="message message--error message--form" id="two_factor-error"
                         style="display: none;"></div>
                    <div class="form__group text--center">
                        <label class="form__label"><?= $lng['two_factor_caption'] ?></label>
                        <input class="form__input text--center" name="two_factor_code" id="two_factor_code"
                               placeholder="------" maxlength="6" autofocus="true"
                               style="display:inline-block;border: 1px solid #e5e5e5;border-radius: 2px;-webkit-box-shadow: none;box-shadow: none;width: 180px;padding: 14px 0px 14px 0px;">
                    </div>
                    <div class="text--center">
                        <div class="m-spinner m-spinner--auth m-spinner--lg" id="loading" style="display: none;"></div>
                        <button type="button" id="two_factor-button"
                                class="btn"><?= $lng['auth_button_signin'] ?></button>
                    </div>
                    <div class="form__links"><?= $lng['auth_or'] ?> <a class="form__link form__link--grey"
                                                                       href="/signout/<?= $_SESSION['authID'] ?>/"><?= $lng['auth_signout'] ?></a>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="container">
            <form class="form form--portal" id="reset-form" method="post" action="" novalidate="novalidate">
                ...
                <div class="form__content">
                    ...
                    <div class="form__links"><?= $lng['auth_or'] ?> <a class="form__link form__link--grey"
                                                                       href="/signin/"><?= $lng['auth_signin_link'] ?></a>
                    </div>
                </div>
            </form>
        </div>
        ...
        <form class="form form--portal" id="reset_code-form" method="post" action="" novalidate="novalidate">
            ...
            <div class="form__content">
                ...
                if ($request_get['status'] != 'success') {
                    echo '<div class="message message--error message--form">' . $request_get['message'] . '</div><div class="form__links">' . $lng['auth_or'] . ' <a class="form__link form__link--grey" href="/signin/">' . $lng['auth_signin_link'] . '</a>';
                } else {
                    ?>
                    ...
                    <div class="form__group">
                        ...
                        <input class="form__input" name="new_password" id="new_password"
                               placeholder="<?= $lng['field_new_password'] ?>" type="password"/>
                        <span class="password-strength" id="password-strength"><?= $lng['password_strength'] ?>
                            : <?= $lng['password_weak'] ?></span>
                    ...
                    <div class="form__group">
                        ...
                        <input class="form__input" name="new_password_confirmation"
                               placeholder="<?= $lng['field_new_password_confirmation'] ?>" type="password"/>
                        <span id="reset_code-new_password_confirmation-error" class="form__error"
