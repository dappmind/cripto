...
?>
	<div class="wrapper">
			...
			<form class="form form--portal-big">
				<div class="form__content">
					...
					<!--<h2 align="center" style="font-size: 19px; text-align: center;">WELCOME TO THE LUCYD WALLET</h2>
						...
						<p style="padding-bottom: 10px;">All major currencies accepted. Paypal contributors will receive their LCD shortly after the ICO end. LCD will become transferable to other wallets and exchanges after ICO end, and bonus tokens will issued at this time as well. If you contribute enough for a Lens preorder, you must retain 5,000 LCD to exchange for it when available. LCD bonus rungs are as follows (equivalent amounts in crypto get same bonus):</p>
      ...
      <p style="text-align: left; padding: 0 15px 0 15px; color: black;">Top 50 donors will be named Lucyd Legends, receive a limited platinum-colored Lucyd Lens, a 3-year extended warranty, and 35% extra LCD.</p>
...
-->
					...
					<p style="text-align: center;padding-top:15px;">For large contributions, please contact <a href="mailto:finance@conciergecoin.com?Subject=Large%20Contribution%20" target="_top">finance@conciergecoin.com</a></p>
					<p style="text-align: center;padding-top:15px;">All purchases are made subject to the Terms and Conditions.</p>
					<p style="text-align: center;padding-top:15px;"><a href="#" target="_blank">Terms & Conditions</a></p>
				</div>
				<!--<div id="vid" align="center"><h2 class="portal-value">How to use the Dashboard:</h2>
				<video width="320" height="240" controls>
  <source src="https://lcd.lucyd.co/assets/videos/LCDwalletGuide.mp4" type="video/mp4">
  <source src="https://lcd.lucyd.co/assets/audio/LCDwalletGuide.ogg" type="video/ogg">
